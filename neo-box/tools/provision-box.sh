...
# des guillemets imbriques a l’interieur de $( ... ) ; pas d’apostrophe ASCII dans les messages.
...
: "${TOKEN:?Relancer avec TOKEN=<jeton longue duree HA>  ; onboarding deja fait}"
