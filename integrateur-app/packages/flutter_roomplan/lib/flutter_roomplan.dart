...
class FlutterRoomplan {
  ...
  /// Open a USDZ file in Apple Quick Look (3D viewer with AR support)
  Future<void> previewUsdz(String filePath) {
    return FlutterRoomplanPlatform.instance.previewUsdz(filePath);
  }
}
